        ...
        while(1) {
            ...
            if(str_len == -1 && errno != EAGAIN) {
                ...
                if(strstr(buf, "GET") != NULL) {
                    ...
                    if(extension != NULL && (strcmp(extension, ".html") == 0 || strcmp(extension, ".jpg") == 0 || strcmp(extension, ".jpeg") == 0 || strcmp(extension, ".png") == 0 || strcmp(extension, ".bmp") == 0|| strcmp(extension, ".css") == 0)) {
