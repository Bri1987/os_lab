...
int init_v4l2(void)
{
    ...
    //opendev
    if ((fd = open(FILE_VIDEO, O_RDWR /*| O_NONBLOCK*/)) == -1)
    {
...
int v4l2_grab(void)
{
    ...
    printf("request for buffers succeed\n");
    ...
    printf("grab VIDIOC_QBUF OK\n");

    type = V4L2_BUF_TYPE_VIDEO_CAPTURE;

    ioctl (fd, VIDIOC_STREAMON, &type);
    printf("grab STREAMON OK\n");

    ioctl(fd, VIDIOC_DQBUF, &buf);
    printf("grab DQBUF OK\n");
